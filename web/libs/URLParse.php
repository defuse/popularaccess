...
class URLParse
{
    ...
    private static $MASTER_HOST = "popularaccess.org";
    private static $ACCEPTED_HOSTS = array(
                                            "localhost",
                                            "192.168.1.102",
                                            "popularaccess.h.defuse.ca",
                                            "popularaccess",
                                            );
    private static $FORCE_HTTPS = false;
    private static $DEFAULT_TITLE = "Popular Access Movement";
    private static $DEFAULT_META_DESC = "Scientists should engage the public in their own research.";
    private static $DEFAULT_META_KEYWORDS = "popular access, popular science, science writing, educators";
    ...
    // http://example.com/one/two/three/four/index.php
    //                       ^   ^     ^    ^
    // ...then $DIRS_TO_IGNORE should be set to 4.
    private static $DIRS_TO_IGNORE = 0;
    ...
    private static $PAGE_INFO = array(
            ...
            "links" => array(
                ...
                P_METD => "Links to Popular Access material.",
                P_METK => "popular science, writing, links",
                ),
            "frequently-asked-questions" => array(
                P_FILE => "faq.php",
                P_TITL => "Popular Access | FAQ", 
                P_METD => "Frequently Asked Questions",
                P_METK => "popular access, faq",
                ),
            );
